...
const featureSMELoanSchema = z.object({
...
const eligibilitySMELoanSchema = z.object({
...
const feesChargesSMELoanSchema = z.object({
...
const createSMELoanValidateSchema = z.object({
    bankName: z.string().min(1, 'Bank name is r equired'),
...
const updateSMELoanValidateSchema = z.object({
...
export const SMELoanValidationSchema = {
