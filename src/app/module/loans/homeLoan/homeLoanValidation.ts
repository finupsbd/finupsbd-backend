...
const featureHomeLoanSchema = z.object({
...
const eligibilityHomeLoanSchema = z.object({
...
const feesChargesHomeLoanSchema = z.object({
...
const createHomeLoanValidateSchema = z.object({
...
const updateHomeLoanValidateSchema = z.object({
...
export const HomeLoanValidationSchema = {
