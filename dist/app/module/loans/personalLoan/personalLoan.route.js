...
router.post('/', sendImageToCloud_1.upload.single('file'), personalLoan_controller_1.PersonalLoanController.createPersonalLoan);
router.get('/', personalLoan_controller_1.PersonalLoanController.getAllPersonalLoan);
router.patch('/:id', sendImageToCloud_1.upload.single('file'), personalLoan_controller_1.PersonalLoanController.updatePersonalLoan);
