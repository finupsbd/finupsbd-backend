...
exports.HomeLoanValidationSchema = void 0;
const zod_1 = require("zod");
// Define the schema for the features
const featureHomeLoanSchema = zod_1.z.object({
...
const eligibilityHomeLoanSchema = zod_1.z.object({
...
const feesChargesHomeLoanSchema = zod_1.z.object({
...
const createHomeLoanValidateSchema = zod_1.z.object({
    ...
    featuresHomeLoan: featureHomeLoanSchema.optional(),
    eligibilityHomeLoan: eligibilityHomeLoanSchema.optional(),
    feesChargesHomeLoan: feesChargesHomeLoanSchema.optional(),
});
const updateHomeLoanValidateSchema = zod_1.z.object({
...
exports.HomeLoanValidationSchema = {
    createHomeLoanValidateSchema,
    updateHomeLoanValidateSchema
};
