...
exports.BankValidationSchema = void 0;
...
const bankInfoValidateSchema = zod_1.z.object({
...
const updateBankInfoValidateSchema = zod_1.z.object({
...
exports.BankValidationSchema = {
    bankInfoValidateSchema,
    updateBankInfoValidateSchema
};
