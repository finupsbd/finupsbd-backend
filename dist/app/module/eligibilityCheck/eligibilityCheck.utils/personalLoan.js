...
const personalLoan = (payload, query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const limit = Number(query.limit) || 10;
    const skip = (page - 1) * limit;
    const sortField = query.sortField || 'interestRate'; // default sort by interestRate
    ...
    let bankList;
    if (query.banks) {
        bankList = query.banks.split(',').map((b) => b.trim());
    }
    // ---------------------------------------------
    // 3) Common Check: user must not have any loan
    // ---------------------------------------------
    if (payload === null || payload === void 0 ? void 0 : payload.haveAnyLoan) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.CONFLICT, 'If you have any existing loan, you cannot apply for a new loan.');
    }
    // ----------------------------
    // 4) Compute Age
    // ----------------------------
    const age = Math.floor((new Date().getTime() - new Date(payload.dateOfBirth).getTime()) / (1000 * 60 * 60 * 24 * 365.25));
    ...
    if ((payload === null || payload === void 0 ? void 0 : payload.profession) === 'SALARIED') {
        const mySalary = ((_b = (_a = payload === null || payload === void 0 ? void 0 : payload.Salaried) === null || _a === void 0 ? void 0 : _a.bankAccount) === null || _b === void 0 ? void 0 : _b.YourSalaryAmountBDT) || 0;
        const experience = ((_c = payload === null || payload === void 0 ? void 0 : payload.Salaried) === null || _c === void 0 ? void 0 : _c.currentJobExperience) || 0;
        // ----------------------------
        ...
        if (minProfitRate !== undefined || maxProfitRate !== undefined) {
            whereClause.interestRate = Object.assign(Object.assign({}, (minProfitRate !== undefined ? { gte: minProfitRate.toString() } : {})), (maxProfitRate !== undefined ? { lte: maxProfitRate.toString() } : {}));
        }
        // If your table has a `maxLoanAmount` field (or something similar):
        if (minLoanAmount !== undefined || maxLoanAmount !== undefined) {
            whereClause.maxLoanAmount = Object.assign(Object.assign({}, (minLoanAmount !== undefined ? { gte: minLoanAmount.toString() } : {})), (maxLoanAmount !== undefined ? { lte: maxLoanAmount.toString() } : {}));
        }
        ...
        // 6) Count total
        const totalCount = yield app_1.prisma.personalLoan.count({ where: whereClause });
        ...
        if (loan.length === 0) {
            throw new AppError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'No personal loans match your eligibility or filters.');
        }
        return {
            data: loan,
            totalCount,
    ...
    if ((payload === null || payload === void 0 ? void 0 : payload.profession) === 'BUSINESS_OWNER') {
        const mySalary = ((_e = (_d = payload === null || payload === void 0 ? void 0 : payload.Salaried) === null || _d === void 0 ? void 0 : _d.bankAccount) === null || _e === void 0 ? void 0 : _e.YourSalaryAmountBDT) || 0;
        const experience = ((_f = payload === null || payload === void 0 ? void 0 : payload.Salaried) === null || _f === void 0 ? void 0 : _f.currentJobExperience) || 0;
