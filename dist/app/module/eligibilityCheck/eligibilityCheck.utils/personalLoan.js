...
const personalLoan = (payload, query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload === null || payload === void 0 ? void 0 : payload.haveAnyLoan) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.CONFLICT, 'If you have any existing loan, you cannot apply for loan');
    }
    if ((payload === null || payload === void 0 ? void 0 : payload.profession) === 'Salaried') {
        console.log("All in one");
        const age = Math.floor((new Date().getTime() - new Date(payload.dateOfBirth).getTime()) /
        ...
        if (loan.length === 0) {
            throw new AppError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'No personal loans match your eligibility.');
        }
        return loan;
    }
