...
exports.verificationPINEmailTemplate = void 0;
const verificationPINEmailTemplate = (name, userId) => {
    return `
   <head>
    <style>
      @keyframes fadeIn {
...
exports.verificationPINEmailTemplate = verificationPINEmailTemplate;
