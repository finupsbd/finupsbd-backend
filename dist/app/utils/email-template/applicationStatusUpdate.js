...
exports.applicationStatusUpdate = void 0;
const applicationStatusUpdate = (applicantNum, applicantName, link) => {
    return `
    <!DOCTYPE html>
<html lang="en">
  <head>
...
exports.applicationStatusUpdate = applicationStatusUpdate;
