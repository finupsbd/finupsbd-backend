...
exports.saveFileAdditional = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const util_1 = __importDefault(require("util"));
const writeFile = util_1.default.promisify(fs_1.default.writeFile);
const saveFileAdditional = (buffer, originalName, applicationId) => __awaiter(void 0, void 0, void 0, function* () {
    // NEW: define the per-application folder
    const appFolder = path_1.default.join(process.cwd(), 'uploads/AdditionalFiles', applicationId);
...
exports.saveFileAdditional = saveFileAdditional;
