...
-- CreateIndex
CREATE UNIQUE INDEX "applicationFrom_userId_key" ON "applicationFrom"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "Address_applicationFormId_key" ON "Address"("applicationFormId");

-- CreateIndex
CREATE UNIQUE INDEX "ApplicationUserInfo_nid_key" ON "ApplicationUserInfo"("nid");

-- CreateIndex
CREATE UNIQUE INDEX "ApplicationUserInfo_emailAddress_key" ON "ApplicationUserInfo"("emailAddress");
...
-- CreateIndex
CREATE UNIQUE INDEX "FinancialObligation_applicationFormId_key" ON "FinancialObligation"("applicationFormId");

-- CreateIndex
CREATE UNIQUE INDEX "DocumentFile_applicationFormId_key" ON "DocumentFile"("applicationFormId");
